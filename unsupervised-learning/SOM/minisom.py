...
class MiniSom:
    def __init__(self, x, y, input_len, sigma=1.0, learning_rate=0.5, decay_function=None, seed=None):
        """
...
class TestMinisom(unittest.TestCase):
    ...
    def test_random_seed(self):
        som1 = MiniSom(5, 5, 2, sigma=1.0, learning_rate=0.5, seed=1)
        som2 = MiniSom(5, 5, 2, sigma=1.0, learning_rate=0.5, seed=1)
    ...
    def test_train_batch(self):
        som = MiniSom(5, 5, 2, sigma=1.0, learning_rate=0.5, seed=1)
        data = array([[4, 2], [3, 1]])
